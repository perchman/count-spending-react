        ...
        <>
            <Routes>
                <Route path="?" element={ <Layout /> }>
                    ...
                    <Route path="cost/update/:id" element={ <CostUpdate /> }/>
                    <Route path="cost/delete/:id" element={ <CostDelete />}/>
                    ...
                    <Route path="balance/history/delete/:id" element={ <HistoryBalanceChangeDelete /> }/>
                </Route>
            </Routes>
        </>
    );
